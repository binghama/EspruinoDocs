...
/*
Module for the MAX30101 heart rate monitor, modified from MAX30102
...
function MAX30101(options,r,w) {
  ...
  if (r(R.PART_ID,1)!=0x55) throw new Error("WHO_AM_I failed");
}

/// Start the heart rate monitor
MAX30101.prototype.init = function() {
  var w=this.w;
...
MAX30101.prototype.readFIFORaw = function() {
...
MAX30101.prototype.decodeRawData = function(d, red, ir) {
  var l = d.length;
...
exports.connect = function(i2c, options) {
  ...
  return new MAX30101(options, function(a,n) { // read
    i2c.writeTo(87,a);
